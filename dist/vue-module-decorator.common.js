...
// CONCATENATED MODULE: ./module/index.ts




function module_Module(store, option) {
  return function (Component) {
    ...
    decorators.push.apply(decorators, _toConsumableArray(operate(store.state, "computed", mapState, module)));
    decorators.push.apply(decorators, _toConsumableArray(operate(store.getters, "computed", mapGetters, module)));
    decorators.push.apply(decorators, _toConsumableArray(operate(store.mutations, "methods", mapMutations, module)));
    decorators.push.apply(decorators, _toConsumableArray(operate(store.actions, "methods", mapActions, module)));
  };
}
    ...
    Object.getOwnPropertyNames(proto).forEach(function (key) {
      ...
      result.push(function (options) {
        ...
        if (typeof options[binging][key] === "undefined") {
          options[binging][key] = namespace ? mapFunc(namespace, [key])[key] : mapFunc([key])[key];
        }
      });
    });
  }
...
function buildNameSpace(component, option) {
  return option ? typeof option.namespace != "undefined" ? option : {
    namespace: component,
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (module_Module);
...
/******/ });
//# sourceMappingURL=vue-module-decorator.common.js.map